file://<WORKSPACE>/streams/src/main/java/org/apache/kafka/streams/StreamsConfig.java
...
action parameters:
offset: 66652
uri: file://<WORKSPACE>/streams/src/main/java/org/apache/kafka/streams/StreamsConfig.java
text:
```scala
/*
...
public class StreamsConfig extends AbstractConfig {
    ...
    protected StreamsConfig(final Map<?, ?> props,
        ...
        if (processi@@ngModeConfig.equals(EXACTLY_ONCE)) {
